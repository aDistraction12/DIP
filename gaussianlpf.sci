//Gaussian LPF
clc;
a=imread("F:\College\4310-Jay Pracs\DIP\cameraman.jpg");
...
subplot(2,2,2); mesh(H); title("Mesh in 3D ");
subplot(2,2,3); imshow(H); title("Mesh using imshow");
subplot(2,2,4); imshow(uint8(X)); title("Final Image");
